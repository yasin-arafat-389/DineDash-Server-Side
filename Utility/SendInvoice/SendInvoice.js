...
const { generateInvoice } = require("../Invoice/Invoice");

const sendInvoice = async (invoiceData, to, receiverName) => {
      ...
      <body>
        <section class="max-w-2xl px-6 py-8 mx-auto bg-white dark:bg-gray-900">
          ...
          <main class="mt-8">
            ...
            Your order has been confirmed. Please find the attached invoice for details. 
           </p>           
