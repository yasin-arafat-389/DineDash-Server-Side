...
const RiderRequestRejected = async (to, name) => {
  ...
  let mailData = {
    ...
    to: to,
    subject: "Rider Request Rejected -- DineDash",
    html: `<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
        ...
        <section class="max-w-2xl px-6 py-8 mx-auto bg-white dark:bg-gray-900">
          ...
          <main class="mt-8">
            ...
            <p class="mt-2 leading-loose text-gray-600 dark:text-gray-300">
              We are extremely sorry to inform you that you are not yet eligible to be a rider at 
              <span class="font-semibold">DineDash</span>.
              <br/>
              We appreciate your interest in becoming a rider at <span class="font-semibold">DineDash</span>.
            </p>  
...
module.exports = { RiderRequestRejected };
