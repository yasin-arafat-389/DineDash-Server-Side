...
const SendVerificationCode = async (to, name, verificationCode) => {
  ...
  let mailData = {
    ...
    to: to,
    subject: "Verify your gmail -- DineDash",
    html: `<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
      ...
      <body>
        <section class="max-w-2xl px-6 py-8 mx-auto bg-white dark:bg-gray-900">
          ...
          <main class="mt-8">
            ...
            Please click the button below to verify your gmail. Remember, without verifying gmail, you will not be able to login to your account.             
            </p>

            <a target='_blank' href=${`https://dine-dash-client.web.app/verify-email/${verificationCode}`}>
